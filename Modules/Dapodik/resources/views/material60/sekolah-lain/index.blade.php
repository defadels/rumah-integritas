                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col-lg-8">
                                    <form class="d-flex flex-wrap align-items-center" action="{{route('dapodik.sekolah-lain')}}">
                                    ...
                                    <div class="text-lg-end">
                                        @can('create sekolah')
                                            <button type="button"
                                                    ...
                                                    onclick="window.location='{{route('dapodik.sekolah-lain.import')}}'">
                                                <i
                                ...
                                <table id="listdata" class="table table-centered table-nowrap mb-0">
                                    ...
                                    @foreach($listdata as $row)
                                        ...
                                        <tr id="data_{{ $row->id }}">
                                            ...
                                            <td>{{$row->npsn}}</td>
                                            <td>{{$row->meja_siswa}}</td>
                                            <td>{{$row->kursi_siswa}}</td>
                                            <td>{{$row->papan_tulis}}</td>
                                            <td>{{$row->komputer}}</td>
                                            <td>{{$row->guru}}</td>
                                            <td>{{$row->tendik}}</td>
                                            <td>{{$row->profile}}</td>
...
@section('script')
    ...
    <script src="{{asset('')}}modules/num-dapodik/sekolah-lain/app.js?v=1.5"></script>
@endsection
