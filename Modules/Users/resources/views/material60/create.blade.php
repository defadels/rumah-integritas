                ...
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{route('users.create')}}" class="parsley-examples" method="post">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="name" class="form-label">Konfirmasi Password<span class="text-danger">*</span></label>
                                    <input type="password" name="password_confirmation" data-parsley-equalto="#password" parsley-trigger="change" required class="form-control" id="password_confirmation"/>
                                </div>
                                ...
                                <div class="mb-3">
                                    <input type="checkbox" checked data-plugin="switchery" data-color="#1bb99a" data-secondary-color="#ff5d48" data-size="small" id="isactive" name="isactive" value="1"/>
