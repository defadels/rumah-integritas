                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col-lg-8">
                                    <form class="d-flex flex-wrap align-items-center" action="{{route('users.roles')}}">
                                ...
                                <div class="col-lg-4">
                                    <div class="text-lg-end">
                                        @can('create roles')
                                            <button onclick="window.location='{{route('users.roles.create')}}'" type="button" class="btn btn-success waves-effect waves-light mb-2 me-2"><i class="mdi mdi-plus-box me-1"></i> Tambah</button>
                                        @endcan
                                    </div>
                                </div><!-- end col-->
                            </div>
                            ...
                            <div class="table-responsive">
                                <table id="listdata" class="table table-centered table-nowrap table-hover mb-0">
                                    ...
                                    @foreach($listdata as $row)
                                        ...
                                        <tr id="data_{{ $row->id }}">
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"
                                                           href="{{route('users.roles.update',['id' => $id])}}"><i
                                                                class="mdi mdi-file-edit"></i> Edit</a>
                                                        <a class="dropdown-item delete_row" href="#"
                                                           data-uid="{{ $id }}"><i
                                                                class="mdi mdi-trash-can"></i> Hapus</a>
                                                        <a class="dropdown-item"
                                                           href="{{route('users.roles.permission',['id' => $id])}}"><i
                                                                class="mdi mdi-security"></i> Permission</a>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="table-user">
                                            ...
                                            <td>
                                                {{isset($row->user_created['name']) ? $row->user_created['name'] : ''}}
                                            </td>
                                            <td>
                                                {{$row->created_at->format('d/m/Y @H:i')}}
                                            </td>
                                            <td>
                                                {{isset($row->user_updated['name']) ? $row->user_updated['name'] : ''}}
                                            </td>
                                            <td>
