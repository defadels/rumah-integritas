                ...
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{route('dapodik.guru.import')}}" enctype="multipart/form-data" class="parsley-examples" method="post">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="text-end">
                                    ...
                                    <button type="reset" class="btn btn-secondary waves-effect" onclick="window.location='{{route('dapodik.guru')}}'">Batal</button>
                                </div>
                            </form>
                        </div>
                    </div> <!-- end card -->
...
@section('script')
    ...
    <script src="{{asset('')}}modules/num-dapodik/guru/app.js?v=1.2"></script>
    <script src="{{asset('')}}modules/num-dapodik/guru/form-advanced.init.js?v=0.6"></script>
    <script src="{{asset('')}}modules/num-dapodik/guru/form-validation.init.js?v=0.4"></script>
@endsection
