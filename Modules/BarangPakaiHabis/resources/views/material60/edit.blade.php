                ...
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{route('form.barang.pakai.habis.update',['id'=>encrypt($barang->id)])}}" class="parsley-examples" method="post">
                                @csrf
                                <div class="mb-3">
                                    <label for="namakegiatan" class="form-label">Nama Kegiatan <span class="text-danger">*</span></label>
                                    <input autofocus type="text" name="namakegiatan" parsley-trigger="change" required class="form-control" id="namakegiatan" value="{{$barang->namakegiatan}}"/>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="tanggalpelaksanaan" parsley-trigger="change" required class="form-control" id="tanggalpelaksanaan" placeholder="Senin, 1/12/2024" value="{{$barang->tanggalpelaksanaan}}"/>
                                </div>

                                <div class="mb-3">
                                    <label for="waktupelaksanaan" class="form-label">Jam Pelaksanaan Kegiatan (08:00 s.d ...) <span class="text-danger">*</span></label>
                                    <input type="text" name="waktupelaksanaan" parsley-trigger="change" required class="form-control col-6" id="waktupelaksanaan" placeholder="08:00 s/d Selesai" value="{{$barang->waktupelaksanaan}}"/>
                                </div>

                                <div class="mb-3">
                                    <label for="lokasikegiatan" class="form-label">Lokasi Kegiatan <span class="text-danger">*</span></label>
                                    <input type="text" name="lokasikegiatan" parsley-trigger="change" required class="form-control" id="lokasikegiatan" value="{{$barang->lokasikegiatan}}"/>
                                </div>

                                <div class="mb-3">
                                    <label for="penanggungjawab" class="form-label">Penanggung Jawab (Pelaksana Kegiatan) <span class="text-danger">*</span>
                                    </label>
                                    <input type="text" name="penanggungjawab" parsley-trigger="change" required class="form-control" id="penanggungjawab" value="{{$barang->penanggungjawab}}"/>
                                </div>

                                <div class="mb-3">
                                    <label for="email" class="form-label">Email <span class="text-danger">*</span></label>
                                    <input autofocus type="email" name="email" parsley-trigger="change" required class="form-control" id="email" value="{{$barang->email}}"/>
                                </div>
