                ...
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{route('dapodik.kepala-sekolah.import')}}" enctype="multipart/form-data" class="parsley-examples" method="post">
                                @csrf
                                <div class="mb-3">
                                    <label for="name" class="form-label">File Excel<span class="text-danger">*</span></label>
                                    <input type="file" name="file_attach" class="form-control" required data-parsley-filemaxmegabytes="10" data-parsley-trigger="change" data-parsley-filemimetypes="application/vnd.ms-excel, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" />
                                </div>
                                ...
                                <div class="text-end">
                                    ...
                                    <button type="reset" class="btn btn-secondary waves-effect" onclick="window.location='{{route('dapodik.kepala-sekolah')}}'">Batal</button>
                                </div>
                            </form>
                        </div>
                    </div> <!-- end card -->
