                            ...
                            <div class="row mb-2">
                                <div class="col-lg-8">
                                    <form class="d-flex flex-wrap align-items-center"
                                          action="{{route('dapodik.sekolah-ruang-guru')}}">
                                    ...
                                    <div class="text-lg-end">
                                        @can('create sekolah')
                                            <button type="button"
                                                    ...
                                                    onclick="window.location='{{route('dapodik.sekolah-ruang-guru.import')}}'">
                                                <i
                            ...
                            <div class="table-responsive">
                                <table id="listdata" class="table table-centered table-nowrap mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <th>NPSN</th>
                                        @php
                                            $fields = collect(['ruang kepsek','ruang guru','ruang tu']);
...
@section('script')
    ...
    <script src="{{asset('')}}modules/num-dapodik/sekolah-ruang-guru/app.js?v=1.5"></script>
@endsection
