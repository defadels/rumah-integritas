                ...
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{route('dapodik.sekolah-lain.import')}}" enctype="multipart/form-data" class="parsley-examples" method="post">
                                @csrf
                                ...
                                <div class="text-end">
                                    ...
                                    <button type="reset" class="btn btn-secondary waves-effect" onclick="window.location='{{route('dapodik.sekolah-lain')}}'">Batal</button>
                                </div>
                            </form>
                        </div>
                    </div> <!-- end card -->
...
@section('script')
    ...
    <script src="{{asset('')}}modules/num-dapodik/sekolah-lain/app.js?v=1.2"></script>
    <script src="{{asset('')}}modules/num-dapodik/sekolah-lain/form-advanced.init.js?v=0.6"></script>
    <script src="{{asset('')}}modules/num-dapodik/sekolah-lain/form-validation.init.js?v=0.4"></script>
@endsection
