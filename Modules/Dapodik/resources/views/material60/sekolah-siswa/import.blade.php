                ...
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{route('dapodik.sekolah-siswa.import')}}" enctype="multipart/form-data" class="parsley-examples" method="post">
                                @csrf
                                ...
                                <div class="text-end">
                                    ...
                                    <button type="reset" class="btn btn-secondary waves-effect" onclick="window.location='{{route('dapodik.sekolah-siswa')}}'">Batal</button>
                                </div>
                            </form>
                        </div>
                    </div> <!-- end card -->
