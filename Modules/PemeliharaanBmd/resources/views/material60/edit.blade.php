                ...
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{route('form.pelihara.update',['id'=>encrypt($pemeliharaan->id)])}}" class="parsley-examples" method="post">
                                @csrf
                                <div class="mb-3">
                                    <label for="name" class="form-label">Nama Pemohon<span class="text-danger">*</span></label>
                                    <input autofocus type="text" name="name" parsley-trigger="change" required class="form-control" id="name" value="{{$pemeliharaan->name}}"/>
                                </div>

                                <div class="mb-3">
                                    <label for="name" class="form-label">Email<span class="text-danger">*</span></label>
                                    <input type="email" name="email" parsley-trigger="change" required class="form-control" id="email" value="{{$pemeliharaan->email}}"/>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    @foreach($role as $row)
                                        <div class="form-check">
                                            <input value="{{$row->id}}" class="form-check-input" type="radio" name="jenis_pelihara" id="customradio1" {{$row->id == $pemeliharaan->jenis_pelihara ? 'checked' : ''}}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input autofocus type="text" name="jenis_keluhan" parsley-trigger="change" required class="form-control" id="name" value="{{$pemeliharaan->jenis_keluhan}}"/>
                                </div>

                                <div class="mb-3">
                                    <label for="name" class="form-label">Sub Bagian/Bagian/Tim<span class="text-danger">*</span></label>
                                    <input autofocus type="text" name="sub_bag" parsley-trigger="change" required class="form-control" id="name" value="{{$pemeliharaan->sub_bag}}"/>
                                </div>
