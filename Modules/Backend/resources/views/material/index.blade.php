...
@section('custom_css')
    <!-- Plugins css -->
    <link href="{{asset('')}}assets/themes/material/assets/libs/flatpickr/flatpickr.min.css" rel="stylesheet" type="text/css" />
    <link href="{{asset('')}}assets/themes/material/assets/libs/selectize/css/selectize.bootstrap3.css" rel="stylesheet" type="text/css" />
@endsection
                                    ...
                                    <div class="table-responsive">
                                        <table
                                            ...
                                            <tr>
                                                <td style="width: 36px;">
                                                    <img
                                                        src="{{asset('')}}assets/themes/material/assets/images/users/user-3.jpg"
                                                        alt="contact-img" title="contact-img"
                                                        class="rounded-circle avatar-sm"/>
                                                </td>
                                            ...
                                            <tr>
                                                <td style="width: 36px;">
                                                    <img
                                                        src="{{asset('')}}assets/themes/material/assets/images/users/user-4.jpg"
                                                        alt="contact-img" title="contact-img"
                                                        class="rounded-circle avatar-sm"/>
                                                </td>
                                            ...
                                            <tr>
                                                <td style="width: 36px;">
                                                    <img
                                                        src="{{asset('')}}assets/themes/material/assets/images/users/user-6.jpg"
                                                        alt="contact-img" title="contact-img"
                                                        class="rounded-circle avatar-sm"/>
                                                </td>
...
@section('script')
    <!-- Plugins js-->
    <script src="{{asset('')}}assets/themes/material/assets/libs/flatpickr/flatpickr.min.js"></script>
    <script src="{{asset('')}}assets/themes/material/assets/libs/apexcharts/apexcharts.min.js"></script>
    <script src="{{asset('')}}assets/themes/material/assets/libs/selectize/js/standalone/selectize.min.js"></script>

    <!-- Dashboar 1 init js-->
    <script src="{{asset('')}}assets/themes/material/assets/js/pages/dashboard-1.init.js"></script>
@endsection
