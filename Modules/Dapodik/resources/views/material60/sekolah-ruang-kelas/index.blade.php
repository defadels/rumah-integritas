                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col-lg-8">
                                    <form class="d-flex flex-wrap align-items-center" action="{{route('dapodik.sekolah-ruang-kelas')}}">
                                    ...
                                    <div class="text-lg-end">
                                        @can('create sekolah')
                                            <button type="button"
                                                    ...
                                                    onclick="window.location='{{route('dapodik.sekolah-ruang-kelas.import')}}'">
                                                <i
                            ...
                            <div class="table-responsive">
                                <table id="listdata" class="table table-centered table-nowrap mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <th>Nama Sekolah</th>
                                        <th>NPSN</th>
                                        <th>Ruang Kelas Baik</th>
                                        <th>Ruang Kelas Rusak Ringan</th>
                                        <th>Ruang Kelas Rusak Sedang</th>
                                        <th>Ruang Kelas Rusak Berat</th>
                                        <th>Ruang Kelas Rusak Total</th>
                                        <th>Jml Ruang Kelas</th>
                                        <th>Ruang Perpus Baik</th>
                                        <th>Ruang Perpus Rusak Ringan</th>
                                        <th>Ruang Perpus Rusak Sedang</th>
                                        <th>Ruang Perpus Rusak Berat</th>
                                        <th>Ruang Perpus Rusak Total</th>
                                        <th>Jml Ruang Perpus</th>
                                        <th>Created At</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @foreach($listdata as $row)
                                        ...
                                        <tr id="data_{{ $row->id }}">
                                            ...
                                            <td>{{$row->npsn}}</td>
                                            <td>{{$row->ruang_kelas_baik}}</td>
                                            <td>{{$row->ruang_kelas_rusak_ringan}}</td>
                                            <td>{{$row->ruang_kelas_rusak_sedang}}</td>
                                            <td>{{$row->ruang_kelas_rusak_berat}}</td>
                                            <td>{{$row->ruang_kelas_rusak_total}}</td>
                                            <td>{{$row->jml_ruang_kelas}}</td>
                                            <td>{{$row->ruang_perpus_baik}}</td>
                                            <td>{{$row->ruang_perpus_rusak_ringan}}</td>
                                            <td>{{$row->ruang_perpus_rusak_sedang}}</td>
                                            <td>{{$row->ruang_perpus_rusak_berat}}</td>
                                            <td>{{$row->ruang_perpus_rusak_total}}</td>
                                            <td>{{$row->jml_ruang_perpus}}</td>
                                            <td>
...
@section('script')
    ...
    <script src="{{asset('')}}modules/num-dapodik/sekolah-ruang-kelas/app.js?v=1.5"></script>
@endsection
