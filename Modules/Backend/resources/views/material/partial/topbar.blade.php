    ...
    <div class="topbar">
        <div class="topbar-menu d-flex align-items-center gap-1">
            ...
            <div class="logo-box">
                ...
                <a href="index.html" class="logo-light">
                    <img src="{{asset('')}}assets/themes/material/assets/images/logo-light.png" alt="logo"
                         class="logo-lg">
        ...
        <ul class="topbar-menu d-flex align-items-center">
            ...
            <li class="app-search dropdown me-3 d-none d-lg-block">
                <form>
                    <input type="search" class="form-control rounded-pill" placeholder="Cari..." id="top-search">
                ...
                <div class="dropdown-menu dropdown-menu-animated dropdown-lg" id="search-dropdown">
                    ...
                    <div class="notification-list">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <div class="d-flex align-items-start">
                                <img class="d-flex me-2 rounded-circle"
                                     src="{{asset('')}}assets/themes/material/assets/images/users/user-2.jpg"
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <div class="d-flex align-items-start">
                                <img class="d-flex me-2 rounded-circle"
                                     src="{{asset('')}}assets/themes/material/assets/images/users/user-5.jpg"
                                     alt="Generic placeholder image" height="32">
                                <div class="w-100">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated dropdown-lg p-0">
                    ...
                    <div class="p-2">
                        <div class="row g-0">
                            <div class="col">
                                <a class="dropdown-icon-item" href="#">
                                    <img src="{{asset('')}}assets/themes/material/assets/images/brands/slack.png"
                                         alt="slack">
                                    <span>Slack</span>
                                </a>
                            </div>
                            <div class="col">
                                <a class="dropdown-icon-item" href="#">
                                    <img src="{{asset('')}}assets/themes/material/assets/images/brands/github.png"
                                         alt="Github">
                                    <span>GitHub</span>
                                </a>
                            </div>
                            <div class="col">
                                <a class="dropdown-icon-item" href="#">
                                    <img src="{{asset('')}}assets/themes/material/assets/images/brands/dribbble.png"
                                         alt="dribbble">
                                    <span>Dribbble</span>
                                </a>
                            </div>
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col">
                                <a class="dropdown-icon-item" href="#">
                                    <img src="{{asset('')}}assets/themes/material/assets/images/brands/dropbox.png"
                                         alt="dropbox">
                                    <span>Dropbox</span>
                                </a>
                            </div>
                            <div class="col">
                                <a class="dropdown-icon-item" href="#">
                                    <img src="{{asset('')}}assets/themes/material/assets/images/brands/g-suite.png"
                                         alt="G Suite">
                                    <span>G Suite</span>
                                </a>
                            </div>
            ...
            {{--<li class="dropdown d-none d-md-inline-block">
                <a class="nav-link dropdown-toggle waves-effect waves-light arrow-none" data-bs-toggle="dropdown"
                   href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <img src="{{asset('')}}assets/themes/material/assets/images/flags/us.jpg" alt="user-image"
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated">
                    ...
                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="{{asset('')}}assets/themes/material/assets/images/flags/germany.jpg" alt="user-image"
                             class="me-1" height="12"> <span class="align-middle">German</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="{{asset('')}}assets/themes/material/assets/images/flags/italy.jpg" alt="user-image"
                             class="me-1" height="12"> <span class="align-middle">Italian</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="{{asset('')}}assets/themes/material/assets/images/flags/spain.jpg" alt="user-image"
                             class="me-1" height="12"> <span class="align-middle">Spanish</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="{{asset('')}}assets/themes/material/assets/images/flags/russia.jpg" alt="user-image"
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="notify-icon">
                                            <img
                                                src="{{asset('')}}assets/themes/material/assets/images/users/avatar-2.jpg"
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="notify-icon">
                                            <img
                                                src="{{asset('')}}assets/themes/material/assets/images/users/avatar-4.jpg"
                                                class="img-fluid rounded-circle" alt=""/>
                                        </div>
                                    </div>
                                    <div class="flex-grow-1 text-truncate ms-2">
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown"
                   href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <img src="@if(Auth::user()->avatar != NULL) {{route('profile.avatar',['filename' => Auth::user()->avatar ])}} @else {{route('profile.avatar',['filename' => 'avatar.png' ])}} @endif" alt="user-image"
