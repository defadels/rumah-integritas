                ...
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{route('form.makan.create')}}" class="parsley-examples" method="post">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="judul_rapat" parsley-trigger="change" required class="form-control" id="judul_rapat"/>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="waktu" parsley-trigger="change" required class="form-control" id="waktu"/>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="jml_konsumsi" parsley-trigger="change" required class="form-control" id="name"/>
                                </div>
